...
/**
 * Sends the password reset link email via {@link EmailSender} (SendGrid), triggered when an
 * account owner requests a reset.
 *
...
public class PasswordResetNotifier {
    ...
    public PasswordResetNotifier(EmailSender emailSender, AppProperties appProperties) {
