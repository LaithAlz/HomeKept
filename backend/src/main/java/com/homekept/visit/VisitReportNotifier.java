...
/**
 * Sends the "visit complete + report ready" email when a visit transitions to COMPLETED.
 *
 ...
 */
@Component
public class VisitReportNotifier {

    private static final Logger log = LoggerFactory.getLogger(VisitReportNotifier.class);

    private final RecipientResolver recipientResolver;
    private final EmailSender emailSender;
    private final AppProperties appProperties;

    public VisitReportNotifier(RecipientResolver recipientResolver,
