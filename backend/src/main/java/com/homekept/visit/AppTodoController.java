...
public class AppTodoController {
     ...
     */
    @GetMapping
    public ResponseEntity<List<TodoResponse>> listTodos(Authentication auth) {
        Long userId = (Long) auth.getPrincipal();
        return ResponseEntity.ok(todoAppService.listTodos(userId));
    }
    ...
    public ResponseEntity<TodoResponse> createTodo(
            ...
            Authentication auth) {
        Long userId = (Long) auth.getPrincipal();
        TodoResponse response = todoAppService.createTodo(userId, request);
    ...
    public ResponseEntity<Void> deleteTodo(
            ...
            Authentication auth) {
        Long userId = (Long) auth.getPrincipal();
        todoAppService.deleteTodo(userId, id);
