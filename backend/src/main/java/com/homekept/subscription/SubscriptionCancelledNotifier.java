 ...
 * Covers both portal cancellations and self-serve cancel-at-period-end.
 * Best-effort; a missing recipient or send failure never breaks webhook processing.
 */
@Component
public class SubscriptionCancelledNotifier {

    private static final Logger log = LoggerFactory.getLogger(SubscriptionCancelledNotifier.class);

    private final RecipientResolver recipientResolver;
    private final EmailSender emailSender;
    private final AppProperties appProperties;

    public SubscriptionCancelledNotifier(RecipientResolver recipientResolver,
