...
> **When to use this:** Open this when a task involves plans, pricing, visits, picks,
> what a technician is and is not allowed to do, materials/receipts, or any
> copy/feature that could touch licensed-trade or advertising law — triggers include
> tiers, Essential/Complete/Premier, founding rate, picks, visit calendar, seasonal,
> scope rails, TSSA/ESA, "not a certified inspection", materials at cost, unit
> economics, Competition Act, CASL, and CPA cooling-off.
...
them here or in code without the founder** (see
...
- **No fabricated social proof (Competition Act).** No invented customer counts,
  ...
  This is the legal spine behind non-negotiable #7 in
  `.codex/skills/homekept-change-control.md` and the whole de-fabrication
  effort.
...
a real frontier — see `.codex/skills/homekept-research-and-methodology.md`.

## When NOT to use this skill / use a sibling instead

- The enforceable non-negotiables and review gates →
  `.codex/skills/homekept-change-control.md`.
- Where domain logic lives in code (packages, entities, state machines) →
  `.codex/skills/homekept-architecture-contract.md`.
- Marketing claims and what may be said publicly →
