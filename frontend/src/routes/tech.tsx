...
import { StatusPill, VisitTypeChip, SeverityTag } from "@/components/tech/TechBits";
import { CompleteVisitSheet } from "@/components/tech/CompleteVisitSheet";
import { IncompleteSheet } from "@/components/tech/IncompleteSheet";
import { FlagSheet } from "@/components/tech/FlagSheet";
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-3 border-b border-border px-5 py-4">
        ...
        <StatusPill status={visit.status} label={STATUS_LABEL[visit.status]} />
      </div>
