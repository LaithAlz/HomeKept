  ...
  return (
    <section className="relative mx-auto max-w-6xl px-6 pb-20 pt-16 md:pt-24">
      <div ref={ref} className="max-w-3xl">
        ...
        >
          Home maintenance <em className="font-[480] italic text-moss">in Milton,</em>
          <br />
          on a schedule.
        </h1>
        ...
        <div className="mt-12 grid gap-10 md:grid-cols-2">
          ...
          >
            ...
            <ul
              ...
              aria-label="Milton neighbourhoods served"
            >
          ...
          >
            ...
            <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
              We serve all Milton addresses whose postal code begins with:
            </p>
    ...
    <section className="px-6 pb-28" aria-labelledby="cta-heading">
      ...
      >
        ...
        <div className="relative">
          ...
          >
            Start with a free{" "}
            <em className="font-[480] italic text-honey-soft">Milton walk-through.</em>
          </h2>
          ...
          <p className="mt-5 text-[13px] text-sage/80">
            No credit card · Cancel anytime · Proudly local to Milton
          </p>
        </div>
      </div>
    </section>
